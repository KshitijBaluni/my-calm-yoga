  ...
  return (
    ...
    >
      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        >
          <p className="mx-auto max-w-xs text-sm leading-relaxed text-foreground/75 md:mx-0">
            {mainText}
          </p>
          <a
            href={readMoreLink}
            className="mt-4 inline-block text-sm font-semibold text-primary underline decoration-from-font underline-offset-4 transition-opacity hover:opacity-70"
          >
            Explore Classes
          </a>
        </motion.div>

        {/* Centre — image with circle */}
        <div className="relative order-1 flex h-full items-center justify-center md:order-2">
          ...
          <motion.div
            ...
            style={{ backgroundColor: 'var(--yoga-circle)', opacity: 0.85 }}
          />
          {/* Yoga image */}
          <motion.img
            src={imageSrc}
        ...
        >
          <h1 className="font-extrabold leading-none tracking-tight text-foreground text-7xl md:text-8xl lg:text-9xl">
            {overlayText.part1}
            <br />
